...
export class WorkdeskLiveArena extends Arena {
    ...
    private textureSrc = '/images/scenery/';
    ...
    update = (): void => {
        ...
        (this.targetCamera as Vector3).x += (-this.mouse.percentage.x * 5 - (this.targetCamera as Vector3).x) / 10;
        (this.targetCamera as Vector3).y += (-(this.mouse.percentage.y * 5) + 40 - (this.targetCamera as Vector3).y) / 10;
